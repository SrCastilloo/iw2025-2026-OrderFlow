    ...
    public class EditarMenuView extends VerticalLayout implements BeforeEnterObserver {
        ...
        private final transient GestionarMenu gestionarMenu;
        private final transient GestionarProducto gestionarProducto;
        private final transient DuennoSesionService duennoSesionService;
        private static final String BACKOFFICE_BG =
        ...
        private static final String ROUTE_PANEL = "/backoffice/duennopanel";
        ...
        private List<Producto> productosDisponibles = List.of();
        ...
        public EditarMenuView(GestionarMenu gestionarMenu,
            ...
            getStyle().set("background", BACKOFFICE_BG);
            ...
            cancelar.addClickListener(e -> volverAlPanel());
        ...
        private void guardarCambios() {
            try {
                ...
                Map<Long, Integer> productosConCantidad =
                        es.uca.orderflow.presentation.components.MenuComposicionMapper
                                .buildMap(composicionList.getChildren().toList());
        ...
        private void volverAlPanel() {
            getUI().ifPresent(ui -> ui.navigate(ROUTE_PANEL));
        }
